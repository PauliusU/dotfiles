...
CapsLock & D:: GetKeyState("Shift", "P")
    ...
    : OpenAppOrFile(EDITOR_CURSOR, 'Cursor')
...
CapsLock & J:: GetKeyState("Shift", "P")
    ? OpenAppOrFile('alacritty', 'ahk_exe alacritty.exe')
    : OpenAppOrFile('wt -p "Git Bash"', 'ahk_exe WindowsTerminal.exe')
...
CapsLock & S:: GetKeyState("Shift", "P")
    ? OpenAppOrFile(EDITOR_VISUAL, 'ahk_exe Code.exe')
    : OpenAppOrFile(FILE_MANAGER, 'ahk_exe TOTALCMD64.EXE')
