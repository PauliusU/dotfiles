...
| Name                                         | Description                                                                                                                                                                                       |
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [.shellrc.sh](/shell/.shellrc.sh)         | Common settings for Zsh config `~/.zshrc` or Bash config `~/.bashrc`.                                                                                                                             |
| [.aliases.sh](/shell/.aliases.sh)         | Shell aliases for Zsh and Bash. Add to `~/.zshrc` or `~/.bashrc` file, or `~/.aliases.sh` (provided you load it in your RC file).                                                                 |
