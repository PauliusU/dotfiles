...
-- Navigation
vim.keymap.set({ "n", "v", "i" }, "<C-f>", "<cmd>silent !tmux neww tmux-sessionizer<CR>", { desc = "Switch tmux sessions" })
-- Switch buffers
...
-- Quickfix navigation
vim.keymap.set("n", "<C-A-k>", "<cmd>cnext<CR>zz")
vim.keymap.set("n", "<C-A-j>", "<cmd>cprev<CR>zz")
...
vim.keymap.set({ "n", "v", "i" }, "<A-q>", "<cmd>q<CR>", { desc = '[Q]uit' })
vim.keymap.set({ "n", "v", "i" }, "<C-A-q>", "<cmd>q!<CR>", { desc = 'Force [q]uit' })
