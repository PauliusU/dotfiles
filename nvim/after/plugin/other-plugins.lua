...
-- hardtime.nvim
-- establish good neovim habits
require("hardtime").setup({
    restricted_keys = {
        -- Override default ["<C-P>"] = { "n", "x" } to allow C-P in normal mode
        ["<C-P>"] = { "x" },
    },
})
...
vim.keymap.set({ "n", "x" }, "<leader>rw", function() require('refactoring').select_refactor() end,
    { desc = 'Prompt refactor' })
